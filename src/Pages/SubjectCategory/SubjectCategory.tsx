...
export default function SubjectCategory() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Logging to debug the selectedSubjects
      console.log("Selected Subjects: ", selectedSubjects);

      // Solution 1: If the backend expects an array
      // await updateUserProfile({ subjects: selectedSubjects }, token);

      // Solution 2: If the backend expects a comma-separated string
      const subjectsAsString = selectedSubjects.join(", ");
      console.log("Subjects as string: ", subjectsAsString);

      await updateUserProfile({ subjects: subjectsAsString }, token);
